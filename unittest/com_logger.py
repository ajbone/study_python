...
class MwFormatter(logging.Formatter):
    '''
    rewrite formatter as json msg format, with colors
    '''
    ...
    def format(self, record):
        ...
        #print_msg = json.dumps(self._msg, ensure_ascii=False, indent=4)
        record.msg = json.dumps(self._msg, ensure_ascii=False, indent=4)
        #u_normal = u'\033[38;5;255m'
        #u_error = u'\033[38;5;9m'
        #u_warn = u'\033[38;5;11m'
        #u_debug = u'\033[38;5;81m'
        #if record.levelname in ['ERROR', 'CRITICAL']:
        #    record.msg = u'{} {} {}'.format(u_error, print_msg, u_normal)
        #elif record.levelname in ['WARNING']:
        #    record.msg = u'{} {} {}'.format(u_warn, print_msg, u_normal)
        #elif record.levelname in ['DEBUG']:
        #    record.msg = u'{} {} {}'.format(u_debug, print_msg, u_normal)
        #else:
        #    record.msg = u'{} {}'.format(u_normal, print_msg)
